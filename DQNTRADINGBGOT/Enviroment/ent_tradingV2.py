...
def running(worm_up=1000, data_range=2000, loading=True):
    ...
    #agent = Agent(alpha=0.001, beta=0.001, input_dims=[len(state)], tau=0.005, batch_size=100, layer1_size=400, layer2_size=300,env=env,n_actions=4, warmup=worm_up)
...
if __name__ == "__main__":
    ...
    while count<10:
        ...
        validation_rate = running(worm_up=wormup, data_range=data_range, loading=loding)
        loding=True
        count += 1
